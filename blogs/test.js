(function () {
  ...
  function d(g, A) {
    ...
    for (var e = 0; e < g.length; ++e) {
      ...
      if ("object" != typeof t)
        return (
          (I.valid = !1),
          (I.error = r + "must be an object, but " + typeof t + " given"),
          I
        );
      if (!m.helper.isString(t.type))
        return (
          (I.valid = !1),
          (I.error =
            r +
      ...
      if (
        ("language" === a && (a = t.type = "lang"),
        "html" === a && (a = t.type = "output"),
        "lang" !== a && "output" !== a && "listener" !== a)
      )
        return (
          (I.valid = !1),
          (I.error =
      ...
      if ("listener" === a) {
        if (m.helper.isUndefined(t.listeners))
          return (
            (I.valid = !1),
            (I.error =
              r +
        ...
        m.helper.isUndefined(t.filter) &&
        m.helper.isUndefined(t.regex)
      )
        return (
          (I.valid = !1),
          (I.error =
      ...
      if (t.listeners) {
        ...
        for (var n in t.listeners)
          if (
            t.listeners.hasOwnProperty(n) &&
            "function" != typeof t.listeners[n]
          )
            return (
              (I.valid = !1),
              (I.error =
      ...
      if (t.filter) {
        ...
        if (
          (m.helper.isString(t.regex) && (t.regex = new RegExp(t.regex, "g")),
          !(t.regex instanceof RegExp))
        )
          return (
            (I.valid = !1),
            (I.error =
        ...
        if (m.helper.isUndefined(t.replace))
          return (
            (I.valid = !1),
            (I.error =
              r +
  ...
  (m.helper = {}),
    ...
    (m.setFlavor = function (g) {
      ...
      m.resetOptions();
      var A = u[g];
      for (var C in ((c = g), A)) A.hasOwnProperty(C) && (l[C] = A[C]);
    }),
    ...
    m.hasOwnProperty("helper") || (m.helper = {}),
    (m.helper.isString = function (g) {
      "use strict";
    ...
    (m.helper.forEach = function (g, A) {
      ...
      if (m.helper.isUndefined(A))
        throw new Error("callback param is required");
      if (!m.helper.isFunction(A))
        throw new Error("callback param must be a function/closure");
      if ("function" == typeof g.forEach) g.forEach(A);
      else if (m.helper.isArray(g))
    ...
    (m.helper.escapeCharactersCallback = r),
    (m.helper.escapeCharacters = function (g, A, C) {
      "use strict";
      var I = "([" + A.replace(/([\[\]\\])/g, "\\$1") + "])";
      C && (I = "\\\\" + I);
      var e = new RegExp(I, "g");
      return (g = g.replace(e, r));
    });
  var p = function (g, A, C, I) {
    "use strict";
    var e,
      r,
      t,
  ...
  (m.helper.matchRecursiveRegExp = function (g, A, C, I) {
    "use strict";
    for (var e = p(g, A, C, I), r = [], t = 0; t < e.length; ++t)
      r.push([
    ...
    (m.helper.replaceRecursiveRegExp = function (g, A, C, I, e) {
      ...
      if (0 < n) {
        var o = [];
        0 !== t[0].wholeMatch.start &&
          o.push(g.slice(0, t[0].wholeMatch.start));
        for (var s = 0; s < n; ++s)
          o.push(
            A(
              g.slice(t[s].wholeMatch.start, t[s].wholeMatch.end),
              g.slice(t[s].match.start, t[s].match.end),
              g.slice(t[s].left.start, t[s].left.end),
              g.slice(t[s].right.start, t[s].right.end)
            )
          ),
            s < n - 1 &&
              o.push(g.slice(t[s].wholeMatch.end, t[s + 1].wholeMatch.start));
        t[n - 1].wholeMatch.end < g.length &&
          o.push(g.slice(t[n - 1].wholeMatch.end)),
          (a = o.join(""));
      }
      return a;
    }),
    ...
    (m.helper.encodeEmailAddress = function (g) {
      ...
      return (g = g.replace(/./g, function (g) {
        if ("@" === g) g = C[Math.floor(2 * Math.random())](g);
        else {
          var A = Math.random();
          g = 0.9 < A ? C[2](g) : 0.45 < A ? C[1](g) : C[0](g);
        }
        return g;
      }));
    }),
    ...
    (m.helper.regexes = { asteriskDashAndColon: /([*_:~])/g }),
    (m.helper.emojis = {
      "+1": "\ud83d\udc4d",
      "-1": "\ud83d\udc4e",
      100: "\ud83d\udcaf",
    ...
    (m.Converter = function (C) {
      ...
      function e(g, A) {
        if (((A = A || null), m.helper.isString(g))) {
          if (((A = g = m.helper.stdExtName(g)), m.extensions[g]))
            return (
              console.warn(
                "DEPRECATION WARNING: " +
                  g +
              ...
              void (function (g, A) {
                "function" == typeof g && (g = g(new m.Converter()));
                m.helper.isArray(g) || (g = [g]);
                var C = d(g, A);
                if (!C.valid) throw Error(C.error);
        ...
        "function" == typeof g && (g = g()), m.helper.isArray(g) || (g = [g]);
        var C = d(g, A);
        if (!C.valid) throw Error(C.error);
        for (var I = 0; I < g.length; ++I) {
          switch (g[I].type) {
          ...
          if (g[I].hasOwnProperty("listeners"))
            for (var e in g[I].listeners)
              g[I].listeners.hasOwnProperty(e) && s(e, g[I].listeners[e]);
        }
      }
      function s(g, A) {
        if (!m.helper.isString(g))
        ...
        n.hasOwnProperty(g) || (n[g] = []), n[g].push(A);
      }
      !(function () {
        for (var g in ((C = C || {}), l)) l.hasOwnProperty(g) && (r[g] = l[g]);
        {
          if ("object" != typeof C)
            throw Error(
          ...
          for (var A in C) C.hasOwnProperty(A) && (r[A] = C[A]);
        }
        r.extensions && m.helper.forEach(r.extensions, e);
      })(),
        (this._dispatch = function (g, A, C, I) {
          if (n.hasOwnProperty(g))
            for (var e = 0; e < n[g].length; ++e) {
              var r = n[g][e](g, A, this, C, I);
              r && void 0 !== r && (A = r);
            }
          return A;
        }),
        ...
        (this.makeHtml = function (A) {
          ...
          return (
            (A = (A = (A = (A = (A = A.replace(/\xa8/g, "\xa8T")).replace(
              /\$/g,
              "\xa8D"
            )).replace(/\r\n/g, "\n")).replace(/\r/g, "\n")).replace(
              /\u00A0/g,
            ...
            r.smartIndentationFix &&
              ((C = (g = A).match(/^\s*/)[0].length),
              (I = new RegExp("^\\s{0," + C + "}", "gm")),
              (A = g.replace(I, ""))),
            (A = "\n\n" + A + "\n\n"),
            (A = (A = m.subParser("detab")(A, r, e)).replace(/^[ \t]+$/gm, "")),
            m.helper.forEach(t, function (g) {
              A = m.subParser("runExtension")(g, A, r, e);
            }),
            (A = m.subParser("metadata")(A, r, e)),
            (A = m.subParser("hashPreCodeTags")(A, r, e)),
            (A = m.subParser("githubCodeBlocks")(A, r, e)),
            (A = m.subParser("hashHTMLBlocks")(A, r, e)),
            (A = m.subParser("hashCodeTags")(A, r, e)),
            (A = m.subParser("stripLinkDefinitions")(A, r, e)),
            (A = m.subParser("blockGamut")(A, r, e)),
            (A = m.subParser("unhashHTMLSpans")(A, r, e)),
            (A = (A = (A = m.subParser("unescapeSpecialChars")(
              A,
              r,
              e
            )).replace(/\xa8D/g, "$$")).replace(/\xa8T/g, "\xa8")),
            (A = m.subParser("completeHTMLDocument")(A, r, e)),
            m.helper.forEach(a, function (g) {
              A = m.subParser("runExtension")(g, A, r, e);
            }),
            (o = e.metadata),
            A
        ...
        (this.setFlavor = function (g) {
          if (!u.hasOwnProperty(g)) throw Error(g + " flavor was not found");
          var A = u[g];
          for (var C in ((I = g), A)) A.hasOwnProperty(C) && (r[C] = A[C]);
        }),
        ...
        (this.removeExtension = function (g) {
          ...
          for (var A = 0; A < g.length; ++A) {
            for (var C = g[A], I = 0; I < t.length; ++I)
              t[I] === C && t[I].splice(I, 1);
            for (; 0 < a.length; ++I) a[0] === C && a[0].splice(I, 1);
          }
        }),
        (this.getAllExtensions = function () {
          return { language: t, output: a };
        }),
        (this.getMetadata = function (g) {
          return g ? o.raw : o.parsed;
        }),
    ...
    m.subParser("anchors", function (g, n, o) {
      ...
      var A = function (g, A, C, I, e, r, t) {
        if (
          ...
          if (
            (C || (C = A.toLowerCase().replace(/ ?\n/g, " ")),
            (I = "#" + C),
            m.helper.isUndefined(o.gUrls[C]))
          )
            return g;
          (I = o.gUrls[C]),
            m.helper.isUndefined(o.gTitles[C]) || (t = o.gTitles[C]);
        }
        var a =
          '<a href="' +
          (I = I.replace(
            m.helper.regexes.asteriskDashAndColon,
            m.helper.escapeCharactersCallback
          )) +
          '"';
        return (
          "" !== t &&
          ...
          n.openLinksInNewWindow &&
            !/^#/.test(I) &&
            (a += ' target="\xa8E95Eblank"'),
          (a += ">" + A + "</a>")
        );
      };
      return (
        (g = (g = (g = (g = (g = o.converter._dispatch(
          "anchors.before",
          g,
          n,
          o
        ...
        n.ghMentions &&
          (g = g.replace(
            ...
            function (g, A, C, I, e) {
              if ("\\" === C) return A + I;
              if (!m.helper.isString(n.ghMentionsLink))
                throw new Error("ghMentionsLink option must be a string");
              var r = n.ghMentionsLink.replace(/\{u}/g, e),
                t = "";
              return (
                n.openLinksInNewWindow && (t = ' target="\xa8E95Eblank"'),
                A + '<a href="' + r + '"' + t + ">" + I + "</a>"
              );
            }
          )),
        (g = o.converter._dispatch("anchors.after", g, n, o))
      );
    });
  var e =
    ...
    o = /<()(?:mailto:)?([-.\w]+@[-a-z0-9]+(\.[-a-z0-9]+)*\.[a-z]+)>/gi,
    s = function (l) {
      "use strict";
      return function (g, A, C, I, e, r, t) {
        ...
        return (
          ...
          l.excludeTrailingPunctuationFromURLs && r && (n = r),
          l.openLinksInNewWindow && (o = ' target="\xa8E95Eblank"'),
          s + '<a href="' + C + '"' + o + ">" + a + "</a>" + n + i
        );
      };
    },
    h = function (e, r) {
      ...
      return function (g, A, C) {
        ...
        return (
          (A = A || ""),
          (C = m.subParser("unescapeSpecialChars")(C, e, r)),
          e.encodeEmails
            ? ((I = m.helper.encodeEmailAddress(I + C)),
              (C = m.helper.encodeEmailAddress(C)))
            : (I += C),
          A + '<a href="' + I + '">' + C + "</a>"
        );
      };
  ...
  m.subParser("autoLinks", function (g, A, C) {
    "use strict";
    return (
      (g = (g = (g = C.converter._dispatch(
        "autoLinks.before",
        g,
        A,
        C
      )).replace(a, s(A))).replace(o, h(A, C))),
    ...
    m.subParser("simplifiedAutoLinks", function (g, A, C) {
      ...
      return A.simplifiedAutoLink
        ? ((g = C.converter._dispatch("simplifiedAutoLinks.before", g, A, C)),
          (g = (g = A.excludeTrailingPunctuationFromURLs
            ? g.replace(t, s(A))
            : g.replace(e, s(A))).replace(n, h(A, C))),
    ...
    m.subParser("blockGamut", function (g, A, C) {
      ...
      return (
        ...
        (g = m.subParser("blockQuotes")(g, A, C)),
        (g = m.subParser("headers")(g, A, C)),
        (g = m.subParser("horizontalRule")(g, A, C)),
        (g = m.subParser("lists")(g, A, C)),
        (g = m.subParser("codeBlocks")(g, A, C)),
        (g = m.subParser("tables")(g, A, C)),
        (g = m.subParser("hashHTMLBlocks")(g, A, C)),
        (g = m.subParser("paragraphs")(g, A, C)),
    ...
    m.subParser("blockQuotes", function (g, A, C) {
      ...
      var I = /(^ {0,3}>[ \t]?.+\n(.+\n)*\n*)+/gm;
      return (
        A.splitAdjacentBlockquotes && (I = /^ {0,3}>[\s\S]*?(?:\n\n)/gm),
        (g = g.replace(I, function (g) {
          return (
            (g = (g = (g = g.replace(/^[ \t]*>[ \t]?/gm, "")).replace(
              /\xa80/g,
              ""
            )).replace(/^[ \t]+$/gm, "")),
            (g = m.subParser("githubCodeBlocks")(g, A, C)),
            (g = (g = (g = m.subParser("blockGamut")(g, A, C)).replace(
              /(^|\n)/g,
              "$1  "
            )).replace(/(\s*<pre>[^\r]+?<\/pre>)/gm, function (g, A) {
              var C = A;
              return (C = (C = C.replace(/^  /gm, "\xa80")).replace(
                /\xa80/g,
                ""
              ));
            })),
            m.subParser("hashBlock")(
              "<blockquote>\n" + g + "\n</blockquote>",
              A,
              C
            )
    ...
    m.subParser("codeBlocks", function (g, t, a) {
      "use strict";
      g = a.converter._dispatch("codeBlocks.before", g, t, a);
      return (
        (g = (g = (g += "\xa80").replace(
          /(?:\n\n|^)((?:(?:[ ]{4}|\t).*\n+)+)(\n*[ ]{0,3}[^ \t\n]|(?=\xa80))/g,
          function (g, A, C) {
            var I = A,
              ...
              r = "\n";
            return (
              (I = m.subParser("outdent")(I, t, a)),
              (I = m.subParser("encodeCode")(I, t, a)),
              (I = (I = (I = m.subParser("detab")(I, t, a)).replace(
                /^\n+/g,
                ""
              )).replace(/\n+$/g, "")),
              t.omitExtraWLInCodeBlocks && (r = ""),
              (I = "<pre><code>" + I + r + "</code></pre>"),
              m.subParser("hashBlock")(I, t, a) + e
            );
          }
        )).replace(/\xa80/, "")),
        (g = a.converter._dispatch("codeBlocks.after", g, t, a))
      );
    }),
    m.subParser("codeSpans", function (g, r, t) {
      "use strict";
      return (
        void 0 === (g = t.converter._dispatch("codeSpans.before", g, r, t)) &&
          (g = ""),
        (g = g.replace(
          /(^|[^\\])(`+)([^\r]*?[^`])\2(?!`)/gm,
          function (g, A, C, I) {
            ...
            return (
              ...
              (e =
                A +
                "<code>" +
                (e = m.subParser("encodeCode")(e, r, t)) +
                "</code>"),
              (e = m.subParser("hashHTMLSpans")(e, r, t))
            );
          }
        )),
        (g = t.converter._dispatch("codeSpans.after", g, r, t))
      );
    }),
    m.subParser("completeHTMLDocument", function (g, A, C) {
      ...
      var I = "html",
        ...
        a = "",
        n = "";
      for (var o in (void 0 !== C.metadata.parsed.doctype &&
    ...
    m.subParser("detab", function (g, A, C) {
      "use strict";
      return (
        (g = (g = (g = (g = (g = (g = C.converter._dispatch(
          "detab.before",
          g,
          A,
          C
        )).replace(/\t(?=\t)/g, "    ")).replace(/\t/g, "\xa8A\xa8B")).replace(
          /\xa8B(.+?)\xa8A/g,
          function (g, A) {
    ...
    m.subParser("ellipsis", function (g, A, C) {
      "use strict";
      return (
        (g = (g = C.converter._dispatch("ellipsis.before", g, A, C)).replace(
          /\.\.\./g,
          "\u2026"
        )),
    ...
    m.subParser("encodeAmpsAndAngles", function (g, A, C) {
      "use strict";
      return (
        (g = (g = (g = (g = (g = C.converter._dispatch(
    ...
    m.subParser("encodeBackslashEscapes", function (g, A, C) {
      ...
      return (
        (g = (g = (g = C.converter._dispatch(
          ...
          A,
          C
        )).replace(/\\(\\)/g, m.helper.escapeCharactersCallback)).replace(
          /\\([`*_{}\[\]()>#+.!~=|-])/g,
          m.helper.escapeCharactersCallback
        )),
    ...
    m.subParser("encodeCode", function (g, A, C) {
      "use strict";
      return (
        (g = (g = C.converter._dispatch("encodeCode.before", g, A, C))
          .replace(/&/g, "&amp;")
          .replace(/</g, "&lt;")
          .replace(/>/g, "&gt;")
          .replace(/([*_{}\[\]\\=~-])/g, m.helper.escapeCharactersCallback)),
    ...
    m.subParser("githubCodeBlocks", function (g, r, t) {
      ...
      return r.ghCodeBlocks
        ? ((g = t.converter._dispatch("githubCodeBlocks.before", g, r, t)),
          (g = (g = (g += "\xa80").replace(
            /(?:^|\n)(```+|~~~+)([^\s`~]*)\n([\s\S]*?)\n\1/g,
            function (g, A, C, I) {
              var e = r.omitExtraWLInCodeBlocks ? "" : "\n";
              return (
                (I = m.subParser("encodeCode")(I, r, t)),
                (I =
                  "<pre><code" +
                  (C ? ' class="' + C + " language-" + C + '"' : "") +
                  ">" +
                  (I = (I = (I = m.subParser("detab")(I, r, t)).replace(
                    /^\n+/g,
                    ""
                  )).replace(/\n+$/g, "")) +
                  e +
                  "</code></pre>"),
                (I = m.subParser("hashBlock")(I, r, t)),
                "\n\n\xa8G" +
                  (t.ghCodeBlocks.push({ text: g, codeblock: I }) - 1) +
                  "G\n\n"
              );
            }
          )).replace(/\xa80/, "")),
          t.converter._dispatch("githubCodeBlocks.after", g, r, t))
        : g;
    }),
    m.subParser("hashBlock", function (g, A, C) {
      "use strict";
      return (
        (g = (g = C.converter._dispatch("hashBlock.before", g, A, C)).replace(
          /(^\n+|\n+$)/g,
          ""
        )),
    ...
    m.subParser("hashCodeTags", function (g, r, t) {
      "use strict";
      g = t.converter._dispatch("hashCodeTags.before", g, r, t);
      return (
        (g = m.helper.replaceRecursiveRegExp(
          g,
          function (g, A, C, I) {
        ...
        (g = t.converter._dispatch("hashCodeTags.after", g, r, t))
      );
    }),
    m.subParser("hashElement", function (g, A, I) {
      ...
      return function (g, A) {
        ...
        return (
          ...
          (C = "\n\n\xa8K" + (I.gHtmlBlocks.push(C) - 1) + "K\n\n")
        );
      };
    }),
    m.subParser("hashHTMLBlocks", function (g, A, r) {
      "use strict";
      g = r.converter._dispatch("hashHTMLBlocks.before", g, A, r);
      var C = [
          "pre",
          "div",
          "h1",
        ...
        I = function (g, A, C, I) {
          var e = g;
          return (
            -1 !== C.search(/\bmarkdown\b/) &&
              (e = C + r.converter.makeHtml(A) + I),
      ...
      for (var e = 0; e < C.length; ++e)
        for (
          var t,
            a = new RegExp("^ {0,3}(<" + C[e] + "\\b[^>]*>)", "im"),
            n = "<" + C[e] + "\\b[^>]*>",
            o = "</" + C[e] + ">";
          -1 !== (t = m.helper.regexIndexOf(g, a));

        ) {
          var s = m.helper.splitAtIndex(g, t),
            i = m.helper.replaceRecursiveRegExp(s[1], I, n, o, "im");
          if (i === s[1]) break;
          g = s[0].concat(i);
        }
      return (
        (g = g.replace(
          /(\n {0,3}(<(hr)\b([^<>])*?\/?>)[ \t]*(?=\n{2,}))/g,
          m.subParser("hashElement")(g, A, r)
        )),
        (g = (g = m.helper.replaceRecursiveRegExp(
          g,
          function (g) {
            return "\n\n\xa8K" + (r.gHtmlBlocks.push(g) - 1) + "K\n\n";
          },
          "^ {0,3}\x3c!--",
          "--\x3e",
          "gm"
        ...
        (g = r.converter._dispatch("hashHTMLBlocks.after", g, A, r))
      );
    }),
    ...
    m.subParser("unhashHTMLSpans", function (g, A, C) {
      ...
      for (var I = 0; I < C.gHtmlSpans.length; ++I) {
        for (var e = C.gHtmlSpans[I], r = 0; /\xa8C(\d+)C/.test(e); ) {
          var t = RegExp.$1;
          if (((e = e.replace("\xa8C" + t + "C", C.gHtmlSpans[t])), 10 === r)) {
    ...
    m.subParser("hashPreCodeTags", function (g, r, t) {
      "use strict";
      g = t.converter._dispatch("hashPreCodeTags.before", g, r, t);
      return (
        (g = m.helper.replaceRecursiveRegExp(
          g,
          function (g, A, C, I) {
            ...
            return (
              "\n\n\xa8G" +
              (t.ghCodeBlocks.push({ text: g, codeblock: e }) - 1) +
              "G\n\n"
            );
          },
          "^ {0,3}<pre\\b[^>]*>\\s*<code\\b[^>]*>",
        ...
        (g = t.converter._dispatch("hashPreCodeTags.after", g, r, t))
      );
    }),
    m.subParser("headers", function (g, n, o) {
      "use strict";
      g = o.converter._dispatch("headers.before", g, n, o);
      var s = isNaN(parseInt(n.headerLevelStart))
          ? 1
          : parseInt(n.headerLevelStart),
        A = n.smoothLivePreview
          ? /^(.+)[ \t]*\n={2,}[ \t]*\n+/gm
          : /^(.+)[ \t]*\n=+[ \t]*\n+/gm,
        C = n.smoothLivePreview
          ? /^(.+)[ \t]*\n-{2,}[ \t]*\n+/gm
          : /^(.+)[ \t]*\n-+[ \t]*\n+/gm;
      g = (g = g.replace(A, function (g, A) {
        var C = m.subParser("spanGamut")(A, n, o),
          I = n.noHeaderId ? "" : ' id="' + i(A) + '"',
          e = "<h" + s + I + ">" + C + "</h" + s + ">";
      ...
      var I = n.requireSpaceBeforeHeadingText
        ? /^(#{1,6})[ \t]+(.+?)[ \t]*#*\n+/gm
        : /^(#{1,6})[ \t]*(.+?)[ \t]*#*\n+/gm;
      function i(g) {
        var A, C;
        ...
        return (
          (A = g),
          (C = m.helper.isString(n.prefixHeaderId)
            ? n.prefixHeaderId
            : !0 === n.prefixHeaderId
            ? "section-"
            : ""),
          n.rawPrefixHeaderId || (A = C + A),
          ...
          n.rawPrefixHeaderId && (A = C + A),
          o.hashLinkCounts[A]
            ? (A = A + "-" + o.hashLinkCounts[A]++)
            : (o.hashLinkCounts[A] = 1),
          A
        );
      }
      return (
        (g = g.replace(I, function (g, A, C) {
          var I = C;
          n.customizedHeaderId && (I = C.replace(/\s?\{([^{]+?)}\s*$/, ""));
          var e = m.subParser("spanGamut")(I, n, o),
            r = n.noHeaderId ? "" : ' id="' + i(C) + '"',
            t = s - 1 + A.length,
            a = "<h" + t + r + ">" + e + "</h" + t + ">";
          return m.subParser("hashBlock")(a, n, o);
        })),
        (g = o.converter._dispatch("headers.after", g, n, o))
      );
    }),
    m.subParser("horizontalRule", function (g, A, C) {
      ...
      return (
        (g = (g = (g = g.replace(/^ {0,2}( ?-){3,}[ \t]*$/gm, I)).replace(
          /^ {0,2}( ?\*){3,}[ \t]*$/gm,
          I
    ...
    m.subParser("images", function (g, A, l) {
      ...
      function n(g, A, C, I, e, r, t, a) {
        ...
        if (
          ...
          if (
            ...
            (I = "#" + C),
            m.helper.isUndefined(n[C]))
          )
            return g;
          (I = n[C]),
            m.helper.isUndefined(o[C]) || (a = o[C]),
            m.helper.isUndefined(s[C]) || ((e = s[C].width), (r = s[C].height));
        }
      ...
      return (
        (g = (g = (g = (g = (g = (g = l.converter._dispatch(
          "images.before",
          g,
          A,
          l
        ...
        (g = l.converter._dispatch("images.after", g, A, l))
      );
    }),
    ...
    m.subParser("lists", function (g, i, s) {
      ...
      function l(g, A) {
        ...
        var C =
          ...
          o = /\n[ \t]*\n(?!\xa80)/.test((g += "\xa80"));
        return (
          i.disableForced4SpacesIndentedSublists &&
            (C =
              /(\n)?(^ {0,3})([*+-]|\d+[.])[ \t]+((\[(x|X| )?])?[ \t]*[^\r]+?(\n{1,2}))(?=\n*(\xa80|\2([*+-]|\d+[.])[ \t]+))/gm),
          (g = (g = g.replace(C, function (g, A, C, I, e, r, t) {
            t = t && "" !== t.trim();
            var a = m.subParser("outdent")(e, i, s),
              n = "";
            return (
              r &&
                i.tasklists &&
                ((n = ' class="task-list-item" style="list-style-type: none;"'),
                (a = a.replace(/^[ \t]*\[(x|X| )?]/m, function () {
                  var g =
              ...
              (a =
                ...
                (a = (a =
                  A || -1 < a.search(/\n{2,}/)
                    ? ((a = m.subParser("githubCodeBlocks")(a, i, s)),
                      m.subParser("blockGamut")(a, i, s))
                    : ((a = (a = m.subParser("lists")(a, i, s)).replace(
                        /\n$/,
                        ""
                      )),
                      ...
                      o
                        ? m.subParser("paragraphs")(a, i, s)
                        : m.subParser("spanGamut")(a, i, s))).replace(
                  "\xa8A",
                  ""
                )) +
                "</li>\n")
      ...
      function e(e, r, t) {
        var a = i.disableForced4SpacesIndentedSublists
            ? /^ ?\d+\.[ \t]/gm
            : /^ {0,3}\d+\.[ \t]/gm,
          n = i.disableForced4SpacesIndentedSublists
            ? /^ ?[*+-][ \t]/gm
            : /^ {0,3}[*+-][ \t]/gm,
          o = "ul" === r ? a : n,
          s = "";
      ...
      return (
        (g = s.converter._dispatch("lists.before", g, i, s)),
        (g += "\xa80"),
        (g = (g = s.gListLevel
          ? g.replace(
              /^(( {0,3}([*+-]|\d+[.])[ \t]+)[^\r]+?(\xa80|\n{2,}(?=\S)(?![ \t]*(?:[*+-]|\d+[.])[ \t]+)))/gm,
        ...
        (g = s.converter._dispatch("lists.after", g, i, s))
      );
    }),
    m.subParser("metadata", function (g, A, I) {
      "use strict";
      if (!A.metadata) return g;
      function e(g) {
        (g = (g = (I.metadata.raw = g)
          .replace(/&/g, "&amp;")
          .replace(/"/g, "&quot;")).replace(/\n {4}/g, " ")).replace(
          /^([\S ]+): +([\s\S]+?)$/gm,
          function (g, A, C) {
      ...
      return (
        ...
        (g = I.converter._dispatch("metadata.after", g, A, I))
      );
    }),
    ...
    m.subParser("paragraphs", function (g, A, C) {
      "use strict";
      for (
        var I = (g = (g = (g = C.converter._dispatch(
            "paragraphs.before",
            g,
            A,
            C
        ...
        var a = I[t];
        0 <= a.search(/\xa8(K|G)(\d+)\1/g)
          ? e.push(a)
          : 0 <= a.search(/\S/) &&
            ((a = (a = m.subParser("spanGamut")(a, A, C)).replace(
              /^([ \t]*)/g,
              "<p>"
            )),
            (a += "</p>"),
      ...
      for (r = e.length, t = 0; t < r; t++) {
        for (var n = "", o = e[t], s = !1; /\xa8(K|G)(\d+)\1/.test(o); ) {
          var i = RegExp.$1,
            l = RegExp.$2;
          (n = (n =
            "K" === i
              ? C.gHtmlBlocks[l]
              : s
              ? m.subParser("encodeCode")(C.ghCodeBlocks[l].text, A, C)
              : C.ghCodeBlocks[l].codeblock).replace(/\$/g, "$$$$")),
            (o = o.replace(/(\n\n)?\xa8(K|G)\d+\2(\n\n)?/, n)),
            /^<pre\b[^>]*>\s*<code\b[^>]*>/.test(o) && (s = !0);
        }
        e[t] = o;
      }
      return (
    ...
    m.subParser("spanGamut", function (g, A, C) {
      ...
      return (
        ...
        (g = m.subParser("codeSpans")(g, A, C)),
        (g = m.subParser("escapeSpecialCharsWithinTagAttributes")(g, A, C)),
        (g = m.subParser("encodeBackslashEscapes")(g, A, C)),
        (g = m.subParser("images")(g, A, C)),
        (g = m.subParser("anchors")(g, A, C)),
        (g = m.subParser("autoLinks")(g, A, C)),
        (g = m.subParser("simplifiedAutoLinks")(g, A, C)),
        (g = m.subParser("emoji")(g, A, C)),
        (g = m.subParser("underline")(g, A, C)),
        (g = m.subParser("italicsAndBold")(g, A, C)),
        (g = m.subParser("strikethrough")(g, A, C)),
        (g = m.subParser("ellipsis")(g, A, C)),
        (g = m.subParser("hashHTMLSpans")(g, A, C)),
        (g = m.subParser("encodeAmpsAndAngles")(g, A, C)),
        A.simpleLineBreaks
    ...
    m.subParser("strikethrough", function (g, I, e) {
      ...
      return (
        I.strikethrough &&
          ((g = (g = e.converter._dispatch(
            "strikethrough.before",
            g,
            I,
            e
          )).replace(/(?:~){2}([\s\S]+?)(?:~){2}/g, function (g, A) {
            return (
              (C = A),
              I.simplifiedAutoLink &&
                (C = m.subParser("simplifiedAutoLinks")(C, I, e)),
              "<del>" + C + "</del>"
            );
            var C;
          })),
          (g = e.converter._dispatch("strikethrough.after", g, I, e))),
        g
      );
    }),
    m.subParser("stripLinkDefinitions", function (g, a, n) {
      ...
      var A = function (g, A, C, I, e, r, t) {
        return (
          (A = A.toLowerCase()),
          C.match(/^data:.+?\/.+?;base64,/)
            ? (n.gUrls[A] = C.replace(/\s/g, ""))
            : (n.gUrls[A] = m.subParser("encodeAmpsAndAngles")(C, a, n)),
          r
            ? r + t
            : (t && (n.gTitles[A] = t.replace(/"|'/g, "&quot;")),
              a.parseImgDimensions &&
                I &&
                e &&
                (n.gDimensions[A] = { width: I, height: e }),
              "")
        );
      };
      return (g = (g = (g = (g += "\xa80").replace(
    ...
    m.subParser("tables", function (g, p, h) {
      "use strict";
      if (!p.tables) return g;
      function A(g) {
        var A,
          C = g.split("\n");
        for (A = 0; A < C.length; ++A)
          /^ {0,3}\|/.test(C[A]) && (C[A] = C[A].replace(/^ {0,3}\|/, "")),
            /\|[ \t]*$/.test(C[A]) && (C[A] = C[A].replace(/\|[ \t]*$/, "")),
            (C[A] = m.subParser("codeSpans")(C[A], p, h));
        var I,
          e,
          r,
          t,
          a,
          n = C[0].split("|").map(function (g) {
            return g.trim();
          }),
          ...
          l = [],
          c = [];
        for (C.shift(), C.shift(), A = 0; A < C.length; ++A)
          "" !== C[A].trim() &&
            s.push(
              C[A].split("|").map(function (g) {
                return g.trim();
              })
            );
        ...
        for (A = 0; A < n.length; ++A)
          m.helper.isUndefined(l[A]) && (l[A] = ""),
            i.push(
              ...
              (t = ""),
              (e = e.trim()),
              (p.tablesHeaderId || p.tableHeaderId) &&
                (t = ' id="' + e.replace(/ /g, "_").toLowerCase() + '"'),
              "<th" +
                t +
                r +
                ">" +
                (e = m.subParser("spanGamut")(e, p, h)) +
                "</th>\n")
            );
        for (A = 0; A < s.length; ++A) {
          for (var u = [], d = 0; d < i.length; ++d)
            m.helper.isUndefined(s[A][d]),
              u.push(
                ((a = s[A][d]),
                "<td" +
                  l[d] +
                  ">" +
                  m.subParser("spanGamut")(a, p, h) +
                  "</td>\n")
              );
          c.push(u);
        }
      ...
      return (
        ...
        (g = h.converter._dispatch("tables.after", g, p, h))
      );
    }),
    m.subParser("underline", function (g, A, C) {
      ...
      return A.underline
        ? ((g = C.converter._dispatch("underline.before", g, A, C)),
          (g = (g = A.literalMidWordUnderscores
    ...
    m.subParser("unescapeSpecialChars", function (g, A, C) {
      ...
      return (
        (g = (g = C.converter._dispatch(
          ...
          A,
          C
        )).replace(/\xa8E(\d+)E/g, function (g, A) {
          var C = parseInt(A);
  ...
  document.addEventListener("DOMContentLoaded", function () {
    ...
    (g.innerHTML =
      'body { padding: 20; font-family:  "Helvetica Neue", Helvetica, Arial, sans-serif;} blockquote { padding: 0 1em; color: #6a737d; border-left: 0.25em solid #dfe2e5;} code { padding: 0.2em 0.4em; background: rgba(27,31,35,0.05); border-radius: 3px;} pre > code { background: none } pre { padding: 16px; overflow: auto; line-height: 1.45; background-color: #f6f8fa; border-radius: 3px; } table { border-collapse: collapse; } td, th {  border: 1px solid #ddd; padding: 10px 13px; } '),
      document.head.appendChild(g);
    var A = document.querySelector("noscript").innerText,
      C = new showdown.Converter({ emoji: !0, underline: !0 });
    C.setFlavor("github"),
        ...
        return [
          {
            ...
            replace: function (g) {
              var A = g.match(/"(.*?)"/)[1];
              return A.includes(window.location.hostname) ||
                "/" == A[0] ||
                "." == A[0]
                ? g
